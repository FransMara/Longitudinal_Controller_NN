"""
This function returns the number of channels we want for our activation function, defined by us, as well as the channel
array that gives the velocities we find at the centers of the channels.
