...
def results(model, history, dataset, time, batch_size):
    '''
    ...
    axes[1].set(xlabel="time", ylabel="acceleration")
    axes[1].legend(['Train', 'Ground Truth'], loc='upper left')
    ...
    axes[2].legend(['Train', 'Ground Truth'], loc='upper left')
